...
/* The item class represents an object that belongs to an user. An item can not exist without an user. The class has three fields, Name, Descprition and Owner (which links the item to a User) */
